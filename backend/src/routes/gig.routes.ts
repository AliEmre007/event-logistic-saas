...
import { createGigSchema, updateGigSchema, assignPerformerSchema, assignAssetSchema } from '../schema/gig.schema';
...
router.put('/:id', validateRequest(updateGigSchema), gigController.updateGig);
